...
public class OrderPriceCalculatorHelperTest {
    ...
    public void caculateOrderPriceFirstTimeCustomerSuccessTest() {
        String customerEmailFilePath = "/pizzadeliverypp/resources/CustomerEmails.csv";
        String orderFilePath = "/pizzadeliverypp/resources/CustomerOrder_1.txt";
    ...
    public void caculateOrderPriceNoEmailProvidedSuccessTest() {
        String customerEmailFilePath = "/pizzadeliverypp/resources/CustomerEmails.csv";
        String orderFilePath = "/pizzadeliverypp/resources/CustomerOrder_2.txt";
    ...
    public void caculateOrderPriceExistingCustomerSuccessTest() {
        String customerEmailFilePath = "/pizzadeliverypp/resources/CustomerEmails.csv";
        String orderFilePath = "/pizzadeliverypp/resources/CustomerOrder_3.txt";
